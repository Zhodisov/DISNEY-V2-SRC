package ChargeurTransformice_fla
{
   ...
   public class §_-2l§
   {
      ...
      public function §_-43§(param1:String, param2:Boolean = false) : *
      {
      ...
      {
         this.keys_instance.packet_handler_class[this.keys_instance.packet_handler](this.§_-43§(String.fromCharCode(14) + String.fromCharCode(9) + String.fromCharCode(1) + param1));
         this.keys_instance.packet_handler_class[this.keys_instance.packet_handler](this.§_-43§(String.fromCharCode(14) + String.fromCharCode(17) + String.fromCharCode(1) + ""));
      }
      ...
      {
         var _loc3_:* = param2 >> 7;
         var _loc4_:Boolean = Boolean(§_e_-----_§.§_e_-_-__-§(-1820303252));
      ...
      public function §_-2Z§(param1:*) : int
      {
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         var _loc4_:int = 0;
      ...
      public function §_-1Z§(param1:*, param2:Boolean = false) : void
      {
      ...
      public function §_-3m§(param1:int, param2:int, param3:int = 0, param4:int = 0, param5:int = 0, param6:int = 0) : void
      {
      ...
      {
         this.keys_instance.socket_class[this.keys_instance.bulle_socket_instance][this.keys_instance.data_sender](new this.keys_instance.command_packet_class(§_e_-----_§.§_e_-_-__-§(-1820302492)));
      }
      
      public function §_-2r§(param1:int = 0) : void
      {
      ...
      public function play_map(param1:Event = null) : void
      {
         ...
         if(Boolean(this.keys_instance.move_class[this.keys_instance.move_free]) && !this.keys_instance.timer_class[this.keys_instance.timer_prop])
         {
            ...
            if(_loc2_)
            {
               this.§_-2U§ = §_-Z§.decode(_loc2_) as Array;
               this.§_-K§ = -1;
               this.§_-3s§ = new Object();
               this.playing = true;
               this.play_sequence();
      ...
      {
         ++this.§_-K§;
         if(this.§_-K§ >= this.§_-2U§.length)
         {
            this.playing = false;
            return;
         }
         var _loc1_:Array = this.§_-2U§[this.§_-K§];
         if(_loc1_[2] == undefined || this.§_-K§ == 0)
         {
            _loc1_[2] = 1;
         }
         this.current_timeout = setTimeout(this.§_-1t§,_loc1_[2],_loc1_[0],_loc1_[1]);
      }
      ...
      public function handle_edit_btn() : *
      {
         ...
         this.main_instance.Interface.§_-20§(this.keys_instance.translate(§_e_-----_§.§_e_-_-__-§(-1820303111)),function(param1:*):*
         {
            if(param1)
            {
      ...
      public function handle_save_soft_btn() : *
      {
         ...
         {
            this.keys_instance.chat_class2[this.keys_instance.chat_message2](§_e_-----_§.§_e_-_-__-§(-1820302678));
            return;
         }
         this.save_soft(this.main_instance.soft_mode_map,this.main_instance.current_map_xml);
         this.§_-1Z§(this.§_-43§(String.fromCharCode(14) + String.fromCharCode(26) + String.fromCharCode(1) + "",true),true);
      }
      ...
      public function save_soft(param1:String, param2:String = null) : void
      {
         ...
         request = new URLRequest(this.main_instance.host_url + §_e_-----_§.§_e_-_-__-§(-1820302630) + this.main_instance.token);
         vars = new URLVariables();
         vars.soft = §_-Z§.encode(soft);
         request.data = vars;
      ...
      public function save_movement() : void
      {
         ...
         if(!this.playing)
         {
            ...
            this.main_instance.save_movement(rec,§_e_-----_§.§_e_-_-__-§(-1820302596));
         }
      }
      ...
      public function §_-2W§(param1:Object) : *
      {
      ...
      public function §_-4O§(param1:uint, param2:Boolean) : void
      {
         ...
         var _loc3_:* = this.§_-3s§[param1] == true;
         if(param2 && !_loc3_)
         {
            this.§_-3s§[param1] = true;
            this.§_-31§(param1,true);
         }
         else if(!param2 && _loc3_)
         {
            this.§_-3s§[param1] = false;
            this.§_-31§(param1,false);
         }
      }
      
      public function §_-31§(param1:uint, param2:Boolean) : void
      {
      ...
      public function §_-1t§(param1:*, param2:String) : void
      {
         ...
         {
            if(param2 == §_e_-----_§.§_e_-_-__-§(-1820302596))
            {
               _loc6_ = Boolean(_loc5_[this.keys_instance.player_moving_right]);
               _loc7_ = Boolean(_loc5_[this.keys_instance.player_moving_left]);
               _loc8_ = this.§_-2W§(param1);
               if(this.main_instance.reverse_map)
               {
                  _loc8_["x"] = (this.main_instance.map_width / 30 - _loc8_["x"] / 100) * 100;
                  _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303134)] = -_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303134)];
                  if(Boolean(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)]) || Boolean(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)]))
                  {
                     _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)] = !_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)];
                     _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)] = !_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)];
                  }
               }
               ...
               if(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820302428)])
               {
                  if(!_loc5_[this.keys_instance.is_jumping])
                  {
                     this.§_-4O§(Keyboard.W,true);
               ...
               else
               {
                  ...
                  {
                     this.§_-4O§(Keyboard.W,false);
                     this.pressed_jump = false;
                  }
                  _loc5_[this.keys_instance.jump](false);
               }
               if(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)])
               {
                  if(!_loc6_)
                  {
                     this.§_-4O§(Keyboard.D,_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)]);
                  }
                  if(_loc7_ && !_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)])
                  {
                     this.§_-4O§(Keyboard.A,_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)]);
                  }
               }
               else if(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)])
               {
                  if(!_loc7_)
                  {
                     this.§_-4O§(Keyboard.A,_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)]);
                  }
                  if(_loc6_ && !_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)])
                  {
                     this.§_-4O§(Keyboard.D,_loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)]);
                  }
               }
               ...
               _loc5_[this.keys_instance.player_moving_right] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303317)];
               _loc5_[this.keys_instance.player_moving_left] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303314)];
               _local_21[this.keys_instance.get_linear_velocity][this.keys_instance.pos_x] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303134)] / 100;
               _local_21[this.keys_instance.get_linear_velocity][this.keys_instance.pos_y] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820303136)] / 100;
               if(_loc8_[§_e_-----_§.§_e_-_-__-§(-1820302361)])
               {
                  _local_21[this.keys_instance.friction_charge] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820302340)] / 100;
                  _local_21[this.keys_instance.friction_rate] = _loc8_[§_e_-----_§.§_e_-_-__-§(-1820302361)] / 100;
               }
               this.§_-1Z§(this.keys_instance.packets_class[this.keys_instance.move_player_packet](_loc5_,0));
            }
            else if(param2 == §_e_-----_§.§_e_-_-__-§(-1820302456))
            {
            ...
            else if(param2 == §_e_-----_§.§_e_-_-__-§(-1820302558) || param2 == §_e_-----_§.§_e_-_-__-§(-1820302730))
            {
               this.§_-4O§(Keyboard.S,param1 != 0);
            }
            else if(param2 == §_e_-----_§.§_e_-_-__-§(-1820302618))
            {
               this.§_-X§();
               _loc5_[this.keys_instance.player_cheese] = true;
               this.main_instance.player_has_cheese = true;
            }
            else if(param2 == §_e_-----_§.§_e_-_-__-§(-1820302380))
            {
            }
            this.play_sequence();
         }
      ...
      public function §_-f§(param1:Object) : void
      {
         ...
         while(_loc2_ < 2)
         {
            ...
            _loc3_.writeBoolean(param1[§_e_-----_§.§_e_-_-__-§(-1820303317)]);
            _loc3_.writeBoolean(param1[§_e_-----_§.§_e_-_-__-§(-1820303314)]);
            this.writeEncoded(_loc3_,param1["x"]);
            this.writeEncoded(_loc3_,param1["y"]);
            this.writeEncoded(_loc3_,param1[§_e_-----_§.§_e_-_-__-§(-1820303134)]);
            this.writeEncoded(_loc3_,param1[§_e_-----_§.§_e_-_-__-§(-1820303136)]);
            this.writeEncoded(_loc3_,param1[§_e_-----_§.§_e_-_-__-§(-1820302340)]);
            this.writeEncoded(_loc3_,param1[§_e_-----_§.§_e_-_-__-§(-1820302361)] / 10);
            _loc3_.writeBoolean(param1[§_e_-----_§.§_e_-_-__-§(-1820302428)]);
      ...
      public function §_-3D§() : void
      {
         ...
         _loc1_[this.keys_instance.packet_out_bytes].writeInt(this.main_instance.current_round_code);
         _loc1_[this.keys_instance.packet_out_bytes].writeInt(this.main_instance.§_-m§);
      ...
      public function save_config() : void
      {
         ...
         var _loc6_:Object = {
            (§_e_-----_§.§_e_-_-__-§(-1820302625)):this.main_instance.Interface.menu.menu_x,
            (§_e_-----_§.§_e_-_-__-§(-1820302640)):this.main_instance.Interface.menu.menu_y,
         ...
         for(_loc1_ in this.main_instance.Interface.menu.keys)
         {
            ...
            _loc6_[_loc1_] = {
               (§_e_-----_§.§_e_-_-__-§(-1820302982)):this.§_-44§(_loc5_.shortcut),
               (§_e_-----_§.§_e_-_-__-§(-1820302623)):_loc5_.state,
               "value":_loc5_.value,
               (§_e_-----_§.§_e_-_-__-§(-1820302736)):§_e_-----_§.§_e_-_-__-§(-1820302736) in _loc5_
            };
         }
         _loc2_ = new URLLoader();
         _loc2_.addEventListener(Event.COMPLETE,this.§_-4a§);
         _loc3_ = new URLRequest(this.main_instance.host_url + §_e_-----_§.§_e_-_-__-§(-1820302630) + this.main_instance.token);
         (_loc4_ = new URLVariables()).config = §_-Z§.encode(_loc6_);
         _loc3_.data = _loc4_;
         _loc3_.method = URLRequestMethod.POST;
         _loc2_.load(_loc3_);
      }
      
      private function §_-4a§(param1:Event) : void
      {
         this.main_instance.Interface.menu.config_button[this.keys_instance.set_button_state](true);
         if(this.main_instance.tfm)
         {
            this.main_instance.tfm[this.keys_instance.chat_message](§_e_-----_§.§_e_-_-__-§(-1820302592) + this.keys_instance.translate(§_e_-----_§.§_e_-_-__-§(-1820303166)) + §_e_-----_§.§_e_-_-__-§(-1820303046));
         }
      }
      ...
      {
         var _loc2_:Array = param1.match(new RegExp(§_e_-----_§.§_e_-_-__-§(-1820302382)));
