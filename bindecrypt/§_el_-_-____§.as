package
{
   ...
   public class §_el_-_-____§ extends Sprite
   {
      ...
      public function §_el_-_____§() : void
      {
         ...
         {
            _loc1_["url"] = String(_loc1_["url"]).replace(new RegExp("http://localhost:8080/","gi"),this.§_el_---_--§);
         }
      }
      ...
      public function §_el_---___§(param1:XML) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            {
               _loc7_["url"] = String(_loc4_.@url).replace(new RegExp("http://localhost:8080/","gi"),this.§_el_---_--§);
            }
            else
            {
